...
%%%%This is where you change your Name.Assigment.Class.etc...
...
(Normal, 11 or 12 pt.) List of equipment (for lab work) and/or tools (such as simulation and analysis software) used to accomplish the work in the report.
\begin{itemize}
...
\captionof{figure}{Final design of the shunt driver circuit}
\label{fig_figure_1}
\end{center}
